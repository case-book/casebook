...
public interface ProjectFileRepository extends JpaRepository<ProjectFile, Long> {
    ...
    void deleteByProjectFileSourceIds(@Param("projectId") Long projectId, @Param("fileSourceType") FileSourceTypeCode fileSourceType, @Param("ids") List<Long> ids);
    ...
    void deleteByProjectFileSourceId(@Param("projectId") Long projectId, @Param("fileSourceType") FileSourceTypeCode fileSourceType, @Param("id") Long id);
