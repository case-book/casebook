...
public class OpenLinkTokenController {
    ...
    public OpenLinkShareResponse selectOpenLinkInfo(@PathVariable String token) {
        ...
        List<TestcaseTemplateDTO> testcaseTemplates = projectService.selectProjectTestcaseTemplateList(openLink.getProject().getId());
        return new OpenLinkShareResponse(openLink, users, testcaseTemplates);
    }
