...
public class TestrunCommentResponse {
    ...
    public TestrunCommentResponse(TestrunCommentDTO testrunCommentDTO) {
        ...
        if (testrunCommentDTO.getUser() != null) {
            this.user = SimpleUserResponse.builder().id(testrunCommentDTO.getUser().getId()).name(testrunCommentDTO.getUser().getName()).email(testrunCommentDTO.getUser().getEmail())
                .avatarInfo(testrunCommentDTO.getUser().getAvatarInfo()).build();
        }
